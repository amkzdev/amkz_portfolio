...
const classes = {
  container: createClass(['flex', 'flex-row', 'items-start', 'gap-2', 'lg:gap-4','rounded','bg-black','p-4','my-3']),
  logo: createClass(['h-auto', 'max-w-full']),
  logoRow: createClass(['basis-1/12']),
  contentRow: createClass(['basis-11/12', 'flex', 'flex-col', 'items-start'])
}
...
export const ExperienceItem = () => {
  ...
  const temp: WorkExperinceType = {
    ...
    companyOverview: ['sdfsdfdsf', 'oversvi'],
  ...
  const { logo, companyName, position , start_date , end_date , duration } = temp
  ...
  return (
    <div className={classes.container}>
      ...
      <div className={classes.contentRow}>
        ...
        <span className='text-lg text-gray-300 leading-8'>{companyName}</span>

        <div className='flex items-center flex-row'>
        <span className='text-base text-gray-500 leading-6'>{start_date}&nbsp;-&nbsp;</span>
        <span className='text-base text-gray-500 leading-6'>{end_date}</span>
