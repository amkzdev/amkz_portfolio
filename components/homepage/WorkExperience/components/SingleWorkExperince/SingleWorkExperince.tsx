import { ProjectType, WorkExperinceType } from '@/types'
...
export const SingleWorkExperince = ({ logo, name, date, industry, stack, techs, description, desktopShots, link, mobileShots }: WorkExperinceType) => {
    return (
