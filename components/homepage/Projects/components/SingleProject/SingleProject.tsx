        ...
        <div className='flex flex-col gap-4'>
            ...
            <div className='flex flex-col lg:flex-row justify-between items-stretch gap-4 lg:items-center w-full'>
                ...
                <div className='flex flex-row gap-4'>
                    ...
                    <div className='w-[90px] lg:w-[120px] aspect-square relative box-border'>
                        <Image src={logo.src} fill alt={name} className='object-fill p-2' />
                    </div>
            ...
            <div className='flex flex-row items-center flex-wrap gap-4'>
                ...
                <div className='flex flex-col gap-4 basis-full lg:basis-1/3'>
                    ...
                    {techs?.map(item => <div className='flex flex-row items-center gap-4'>
                        <div className='w-[60px] lg:w-[90px] aspect-square relative'>
                            <Image src={item.image.src} fill alt={item.name} />
                        </div>
                        <span>{item.name}</span>
                    </div>)}
